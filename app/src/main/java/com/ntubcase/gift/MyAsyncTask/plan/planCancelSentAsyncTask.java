...
public class planCancelSentAsyncTask extends AsyncTask<String, Integer, String> {
...
//----------------------------------------------------
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final planCancelSentAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public planCancelSentAsyncTask(planCancelSentAsyncTask.TaskListener taskListener) {
        ...
        try {
            ...
            String args =
                    "userid=" + URLEncoder.encode(params[1], "UTF-8") +
                            ...
                            "&store=" + URLEncoder.encode(params[3], "UTF-8");
            Log.v("planCancelSent", args);
