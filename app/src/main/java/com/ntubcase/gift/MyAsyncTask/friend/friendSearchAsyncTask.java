...
public class friendSearchAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final friendSearchAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public friendSearchAsyncTask(friendSearchAsyncTask.TaskListener taskListener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            "&mail=" + URLEncoder.encode(params[2], "UTF-8");
