...
public class multiplePlanInsertAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final multiplePlanInsertAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public multiplePlanInsertAsyncTask(multiplePlanInsertAsyncTask.TaskListener taskListener) {
