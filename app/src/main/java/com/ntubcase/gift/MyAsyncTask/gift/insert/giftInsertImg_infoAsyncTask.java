...
public class giftInsertImg_infoAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    //---------------------------------------
    public giftInsertImg_infoAsyncTask(TaskListener taskListener) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String args =
                    "filename=" + URLEncoder.encode(params[1], "UTF-8")+
