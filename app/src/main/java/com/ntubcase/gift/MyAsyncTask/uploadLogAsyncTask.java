...
public class uploadLogAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    //---------------------------------------
    public uploadLogAsyncTask(TaskListener taskListener) {
