...
public class receiveUploadCompleteAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final receiveUploadCompleteAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public receiveUploadCompleteAsyncTask(receiveUploadCompleteAsyncTask.TaskListener taskListener) {
