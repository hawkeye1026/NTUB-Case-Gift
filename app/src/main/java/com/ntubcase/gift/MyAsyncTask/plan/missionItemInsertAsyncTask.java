...
public class missionItemInsertAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final missionItemInsertAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public missionItemInsertAsyncTask(missionItemInsertAsyncTask.TaskListener taskListener) {
