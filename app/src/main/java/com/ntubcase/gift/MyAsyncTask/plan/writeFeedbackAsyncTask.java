...
public class writeFeedbackAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final writeFeedbackAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public writeFeedbackAsyncTask(writeFeedbackAsyncTask.TaskListener taskListener) {
        ...
        try {
            ...
            String args =
                    "planid=" + URLEncoder.encode(params[1], "UTF-8") +
                            ...
                            "&feedback=" + URLEncoder.encode(params[3], "UTF-8");
