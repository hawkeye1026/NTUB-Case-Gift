package com.ntubcase.gift.MyAsyncTask.gift.delete;
...
public class giftDeleteAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    //---------------------------------------
    public giftDeleteAsyncTask(TaskListener taskListener) {
