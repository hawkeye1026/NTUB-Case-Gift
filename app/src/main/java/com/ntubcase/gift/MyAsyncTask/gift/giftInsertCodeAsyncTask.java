...
public class giftInsertCodeAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final giftInsertCodeAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public giftInsertCodeAsyncTask(giftInsertCodeAsyncTask.TaskListener taskListener) {
