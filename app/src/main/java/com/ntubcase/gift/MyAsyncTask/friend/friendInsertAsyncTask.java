package com.ntubcase.gift.MyAsyncTask.friend;
...
public class friendInsertAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    // 接收回傳值的物件參考
    //----------------------
    private final friendInsertAsyncTask.TaskListener taskListener;

    //---------------------------------------
    // 建構元, 傳入context及接收回傳值的物件
    //---------------------------------------
    public friendInsertAsyncTask(friendInsertAsyncTask.TaskListener taskListener) {
        ...
        try {
            ...
            String args =
                    "userid=" + URLEncoder.encode(params[1], "UTF-8")+
                            "&friendid=" + URLEncoder.encode(params[2], "UTF-8");
